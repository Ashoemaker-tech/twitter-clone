...
const getFile = (e) => {
    ...
    showUpload.value = URL.createObjectURL(e.taget.files[0])
        ...
        <div class="max-w-[1400px] flex mx-auto">
            <div class="lg:w-3/12 w-[60px] h-[100vh] max-w-[350px] lg:px-4 lg:mx-auto">
                ...
                <button @click="createTweet = true" class="lg:w-full mt-8 ml-2 text-white font-extrabold text-[22px] bg-[#1c9cef] p-3 px-3 rounded-full cursor-pointer">
                    ...
                    <span class="lg:hidden block"><Feather /></span>
                </button>
            </div>
            ...
            <div class="lg:block hidden lg:w-4/12 h-screen border-l border-gray-800 pl-4">
                <div class="w-full p-1 mt-2 px-4 lg:flex items-center rounded-full hidden bg-[#212327]">
                    ...
                    <input class="appearance-none w-full border-0 py-2 bg-[#212327] text-gray-100 placeholder-gray-500 leading-tight focus:ring-0" 
                    type="text" 
                ...
                <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
                    ...
                    <div class="h-[80px] hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold mb-6 text-[17px]">US Open 2023</div>
                            </div>
                    ...
                    <div class=" hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text-[14px] text-gray-400">Trending in United States</div>
                                <div class="w-full text-white font-extrabold text-[17px]">Doomsday Clock</div>
                                <div class="text-[14px] text-gray-400">6,123 Tweets</div>
                            </div>
                    ...
                    <div class=" hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text-[14px] text-gray-400">News • Trending</div>
                                <div class="w-full text-white font-extrabold text-[17px]">Russia Vs US</div>
                                <div class="text-[14px] text-gray-400">12,123 Tweets</div>
                            </div>
                            <DotsHorizontal fillColor="#5e5c5c" />
                        </div>
                    </div>
                    <div class=" hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[17px]">President Biden Gafs Again</div>
                                <div class="text-[14px] text-gray-400">1,912 Tweets</div>
                            </div>
                            <DotsHorizontal fillColor="#5e5c5c" />
                        </div>
                    </div>
