...
class TweetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $request->validate(['file' => 'required|image|mimes:jpeg,png,jpg,mp4']);
        ...
        $tweet = new Tweet;
        $tweet->name = 'Andrew Shoemaker';
        $tweet->handle = '@Ashoemaker_tech';
        $tweet->image = 'https://avatars.githubusercontent.com/u/79344687?s=96&v=4';
